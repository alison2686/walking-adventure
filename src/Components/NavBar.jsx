  ...
  return (
    <div className="h-[10%]">
      <div className=" flex justify-between w-[100%] bg-[#69a1ac] text-white z-30">
        <Link to="/">
          <h1 className="w-[20%] font-lobster text-4xl p-4">Strolls</h1>
        </Link>
        ...
        <div
          className={
            !nav
              ? "fixed left-[-100%]"
              : "z-10 fixed left-0 top-0 w-[60%] h-full bg-[white] text-black ease-in-out duration-500"
          }
        >
          <Link to="/">
            <h1 className="w-[20%] font-lobster text-black text-4xl p-4">
              Strolls
            </h1>
          </Link>
