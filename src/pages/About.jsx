  ...
  return (
    <div className="h-[100%] bg-white text-black scroll-smooth">
      ...
      <div className="h-[30%] pb-[5%]">
        <h1 className="font-poppins text-3xl font-bold text-center pb-5  pt-[4rem]">
          About Us
        </h1>
        <div className="flex flex-col md:flex-row justify-content items-center">
          ...
          <p className="font-poppins text-center pt-6 px-6 md:text-right md:mr-4 md:px-4 lg:text-xl md:w-[50%] ">
            {" "}
            The Strolls team is a mix of developers, designers, mentors, and
            product managers! We all met during the Girl Develop It Hackathon
            and collaborated to create this app from the ground up! We come from
            a diverse background of skillsets, and pride ourselves in
            organization, communication, mentorship, and supporting our
            teammates.
            <br /> Strolls is built with a Ruby on Rails back end and React.js
            front end. All our styling is done with TailwindCSS, and our designs
            with Figma. To keep us organized, we used a kanban board on Trello.{" "}
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-around mt-10">
          <div className="flex-col w-[100%] md:w-[30%] text-center pb-5">
            <h1 className="font-poppins font-bold text-2xl pb-4 text-center">
              Design
            </h1>
